...
// Insert into TranslationKeys
content = content.replace(/deleteAllCardRecordsDesc: string;/, 'deleteAllCardRecordsDesc: string;' + keysToAdd);

// Insert into tr
content = content.replace(/deleteAllCardRecordsDesc: 'Kart ve tüm harcama kayıtları silinir.',/, "deleteAllCardRecordsDesc: 'Kart ve tüm harcama kayıtları silinir.'," + trToAdd);
// Insert into en
content = content.replace(/deleteAllCardRecordsDesc: 'Card and all expense records will be deleted.',/, "deleteAllCardRecordsDesc: 'Card and all expense records will be deleted.'," + enToAdd);
// Insert into es
content = content.replace(/deleteAllCardRecordsDesc: 'La tarjeta y todos los registros serán eliminados.',/, "deleteAllCardRecordsDesc: 'La tarjeta y todos los registros serán eliminados.'," + esToAdd);
// Insert into fr
content = content.replace(/deleteAllCardRecordsDesc: 'La carte et tous les enregistrements seront supprimés.',/, "deleteAllCardRecordsDesc: 'La carte et tous les enregistrements seront supprimés.'," + frToAdd);
// Insert into zh
content = content.replace(/deleteAllCardRecordsDesc: '卡和所有支出记录将被删除。',/, "deleteAllCardRecordsDesc: '卡和所有支出记录将被删除。'," + zhToAdd);
// Insert into hi
content = content.replace(/deleteAllCardRecordsDesc: 'कार्ड और सभी व्यय रिकॉर्ड हटा दिए जाएंगे।',/, "deleteAllCardRecordsDesc: 'कार्ड और सभी व्यय रिकॉर्ड हटा दिए जाएंगे।'," + hiToAdd);
