...
import { CreditCard as CardIcon, X, CheckCircle, ArrowRight, ShieldCheck } from 'lucide-react';
      ...
      <div className="bg-white border border-gray-100 rounded-3xl w-full max-w-md p-6 shadow-2xl text-gray-900 space-y-5 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 pb-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-lg text-gray-900 leading-tight">Kart Ödemesi Gir</h3>
              <p className="text-xs text-gray-500">{card.name} (••• {card.last4})</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="bg-gray-50 rounded-2xl p-4 border border-gray-200/80 space-y-3">
          ...
          <div className="flex justify-between items-center text-xs text-gray-600 border-t border-gray-200/60 pt-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="bg-gray-50 hover:bg-gray-100 text-xs font-medium py-2 px-3 rounded-2xl border border-gray-200 text-gray-800 text-left transition-colors cursor-pointer"
              >
                <div className="text-[10px] text-gray-400 font-semibold">Tüm Borcu Kapat</div>
                <div className="font-extrabold text-blue-600">{formatTL(cycleInfo.totalUnpaidDebt)}</div>
              </button>
              ...
              <button
                ...
                className="bg-gray-50 hover:bg-gray-100 text-xs font-medium py-2 px-3 rounded-2xl border border-gray-200 text-gray-800 text-left transition-colors cursor-pointer"
              >
                <div className="text-[10px] text-gray-400 font-semibold">Dönem Net Borç</div>
                <div className="font-extrabold text-indigo-600">{formatTL(cycleInfo.currentCycleNetDebt)}</div>
              </button>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                placeholder="0.00"
                required
                className="w-full bg-gray-50 border-2 border-blue-600/80 focus:border-blue-600 rounded-2xl py-3 px-4 text-2xl font-extrabold text-gray-900 tracking-tight focus:outline-none"
              />
              <span className="absolute right-4 top-1/2 -translate-y-1/2 font-bold text-blue-600 text-lg">
                ₺
              </span>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-200 rounded-2xl py-2.5 px-3 text-xs text-gray-800 focus:outline-none focus:border-blue-600"
            />
          </div>
