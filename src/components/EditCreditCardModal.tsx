...
export const EditCreditCardModal: React.FC<EditCreditCardModalProps> = ({ card, onClose, onUpdateCard }) => {
  ...
  const [cutoffDay, setCutoffDay] = useState(card.cutoffDay);
  const [dueDayOffsetDays, setDueDayOffsetDays] = useState(card.dueDayOffsetDays);
