...
// Sıfırlanmış kayıtlı kart listesi (Hiçbir kart kayıtlı değil)
export const DEFAULT_CREDIT_CARDS: CreditCard[] = [];

// Kullanıcının notlarından birebir derlenmiş ve tarihsel sıraya dizilmiş tam işlem listesi
export const INITIAL_TRANSACTIONS: Transaction[] = [
  ...
  // 11.500 Kredi Kartı Ödeme - Yeni Ay Başlangıcı
  {
    id: 'tx-40',
    type: 'expense',
    amount: 130,
